...
function cleanSummary(summary) {
  return String(summary || '')
    ...
    .replace(/^(birthday of|birthday:|birthday|verjaardag van|verjaardag|geburtstag von|geburtstag|anniversaire de|anniversaire|compleanno|cumpleaños|urodziny)\s*[:\-]?\s*/i, '')
...
function parseIcal(input, sourceId, sourceName) {
  ...
  function finishEvent(current) {
    ...
    const dateOfBirth = dateFromValue(rawDate && (rawDate.value || rawDate));
